...
function MainPage({ setVariables }) {

  const navigate = useNavigate();

  const handleContentButtonClick = (variable, variable2) => {
    // const encodedVariable2 = encodeURIComponent(variable2);
            ...
            <tbody>
                {regularText.map((regular,index)=>(
                    <tr key={index}>
                        ...
                        <td>{regular[3]}</td>
                        <td>
                          <button onClick={() => handleContentButtonClick(regular[2], regular[0])}>
                            Content
                          </button>
                        </td>
